...
public class SFTPDemo {
    private static final String REMOTE_HOST = "131.116.76.22";
    private static final String USERNAME = "abhi";
    private static final String PASSWORD = "nikon800";
    ...
    public static void main(String[] args) {
        ...
        String remoteFile = "cdtempty_file.txt";
