...
public class ReadTextFile {
    ...
    public List<String> readTextFile() {
        ...
        //try (FileReader file = new FileReader("C:\\MyJava\\AdventOfCode2021\\2-Dec\\input.txt");
    ...
    public static void main(String[] args) {
        //ReadTextFile readTextFile = new ReadTextFile("C:\\MyJava\\AdventOfCode2021\\2-Dec\\input_example.txt"); //OK
    ...
    // Each url is separated by pipe. Using it to capture all urls from open tabs in firefox browser
    ...
    public List<String> readTextFileFromResources(String fileName) {
        String concatFileName = "/readtextfile/".concat(fileName);
